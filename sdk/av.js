...
module.exports = function (AV) {
   ...
   *
   * <p>Example:</p><pre>   *   var point = new AV.GeoPoint(30.0, -20.0);
...
module.exports = function (AV) {
   ...
   *
   *        For example:<pre>   * var fileUploadControl = $("#profilePhotoFileUpload")[0];
  ...
  /** @lends AV.File.prototype */
  {
     ...
     * <p></p><pre>     *  var metadata = file.metaData(); //Get metadata JSON object.
...
module.exports = function (AV) {
   ...
   * subclass is appropriate, you can use this form:</p><pre>   *     var object = new AV.Object("ClassName");
   * </pre>
   * That is basically equivalent to:<pre>   *     var MyClass = AV.Object.extend("ClassName");
  ...
  /** @lends AV.Object.prototype */
  {
     ...
     * You can either call it as:<pre>     *   object.save();</pre>
     * or<pre>     *   object.save(null, options);</pre>
     * or<pre>     *   object.save(attrs, options);</pre>
     * or<pre>     *   object.save(key, value, options);</pre>
     *
     * @example
     * gameTurn.save({
     *   player: "Jake Cutter",
   ...
   * It's the same with
   * <pre>   *   new AV.Object(attributes, options);
   *  </pre>
   * @param {Object} attributes The initial set of data to store in the object.
   * @param {Object} options A set of Backbone-like options for creating the
   *     object.  The only option currently supported is "collection".
...
module.exports = function (AV) {
   ...
   *
   * </p><pre>   * var query = new AV.Query(MyClass);
...
module.exports = function (AV) {
  ...
  /** @lends AV.Insight */
  {
     ...
     * @param {Object} jobConfig 任务配置的 JSON 对象，例如：<code><pre>     *                   { "sql" : "select count(*) as c,gender from _User group by gender",
     *                     "saveAs": {
...
//# sourceMappingURL=av.js.map</leaderboardarchive[]></av.leaderboard></av.leaderboard></av.leaderboard></ranking[]></ranking[]></number></av.leaderboard></void></statistic[]></statistic[]></av.leaderboard></av.leaderboard></void></void></void></string></date></av.captcha></string></string></av.object></av.object></xzhuang@avoscloud.com></av.user></av.user></av.user></av.user></av.user></av.user></av.user></av.role[]></av.user></boolean></av.user></av.user></av.user></av.user></av.user></av.user></av.user></av.user></av.user></av.user></av.object[]></https:></string></string></string></av.geopoint></seenobjects>